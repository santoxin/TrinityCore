...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SPAWN_CREATUREGROUP                = 128,    // Group ID, min secs, max secs
    SMART_ACTION_DESPAWN_CREATUREGROUP              = 129,    // Group ID, min secs, max secs
    SMART_ACTION_SPAWN_GAMEOBJECTGROUP              = 130,    // Group ID, min secs, max secs
    SMART_ACTION_DESPAWN_GAMEOBJECTGROUP            = 131,    // Group ID, min secs, max secs
