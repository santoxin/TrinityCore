...
APATH=/home/legacycore/server/bin
WPATH=/home/legacycore/server/bin
ASRV_BIN=authserver         #This usually doesnt change. TrinityCore: authserver  MaNGOS: realmd  ArcEmu: whocares?
WSRV_BIN_ORG=worldserver    #This usually doesnt change. TrinityCore: worldserver MaNGOS: mangosd ArcEmu: whocares?
