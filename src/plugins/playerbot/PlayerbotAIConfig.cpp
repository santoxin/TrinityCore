...
*/
    ...
    if (!enabled)
    {
        sLog->outMessage("playerbot", LOG_LEVEL_ERROR, "AI Playerbot is Disabled in aiplayerbot.conf");
        return false;
    }
    ...
    aracgen = sConfigMgr->GetBoolDefault("AiPlayerbot.ARAC", true);
    ...
    sLog->outMessage("playerbot", LOG_LEVEL_ERROR, "AI Playerbot configuration loaded");
